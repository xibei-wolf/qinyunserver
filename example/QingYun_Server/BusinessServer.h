...
namespace qingyun
{
    ...
    public:
        ...
        // 业务路由（Router）
        // ==================================================================
        using HandlerFunc = std::function<void(const net::TcpConnectionPtr &,
                                               const nlohmann::json &)>;
        ...
        /// 根据 action 字段分发请求
        void dispatchAction(const net::TcpConnectionPtr &conn,
        ...
        void handleLogin(const net::TcpConnectionPtr &conn,
                         const nlohmann::json &jsonObj);

        void handleUploadSchedule(const net::TcpConnectionPtr &conn,
                                  const nlohmann::json &jsonObj);
